...
- クリップ機能
  ...
  - クリップの情報を保存できます。ただし外部システムとの連携が必要となるので、"LocalTube"をインストールし、設定してください。
- フィルタリング機能
...
または以下のコマンドを実行し、YoutubeExtensionをクローンしてください。
```
...
- "保存(localhost連携)"をクリックすると、クリップ情報がLocalTubeに保存できます。
...
- テキストやボタンなどにフォーカスが当たっていない場合、画面上からプレーヤーを操作することができます。
  ...
  - Spageキー：動画の再生/停止
  - Jキーまたは左矢印キー：動画を5秒戻す
  - Lキーまたは右矢印キー：動画を5秒進める
  - Iキーまたは上矢印キー：音量を上げる
  - Kキーまたは下矢印キー：音量を下げる
  - 0〜9の数字キー：数字に応じた時刻にプレーヤーを設定する
